...
import com.commons.adapters.ArrayAdapter
import com.commons.utilities.extensions.applyColorFilter

class AppCompatSpinner : AppCompatSpinner {
    ...
    fun setColors(textColor: Int, accentColor: Int, backgroundColor: Int) {
        ...
        adapter = ArrayAdapter(context, android.R.layout.simple_spinner_item, items, textColor, backgroundColor, padding)
